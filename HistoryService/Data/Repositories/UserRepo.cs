...
{
    public class UserRepo : AbstractRepo, IBaseRepo<User>
    {
        private readonly AppDbContext _context;

        public UserRepo(AppDbContext context, IHttpContextAccessor httpContextAccessor) : base(httpContextAccessor)
        {
            _context = context;
        }
