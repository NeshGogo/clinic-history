...
{
    public class DoctorRepository : AbstractRepository, IBaseRepository<Doctor>
    {
        private readonly AppDbContext _context;

        public DoctorRepository(AppDbContext context, IHttpContextAccessor httpContextAccessor) : base(httpContextAccessor)
        {
            _context = context;
        }
